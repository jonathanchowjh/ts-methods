[ts-ethers](../README.md) / [Modules](../modules.md) / [error](../modules/error.md) / DefaultError
...
[src/error.ts:14](https://github.com/jonathanchowjh/ts-utils/blob/bca7b1f/src/error.ts#L14)
